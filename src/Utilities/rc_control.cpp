...
* or PX4_sender subscribed to /easondrone/control_command sent by the RC_Control and Terminal_Control nodes
...
int main(int argc, char **argv)
{
    ...
    swb_pub = nh.advertise<easondrone_msgs::ControlCommand>("/easondrone/control_command", 10);
...
inline void timerCallback()
{
    cout << ">>>>>>>>>>>>>>>> Welcome to use EasonDrone RC Control <<<<<<<<<<<<<<<<"<< endl;
    cout << endl;
