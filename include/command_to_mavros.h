...
#ifndef PX4CTRL_COMMAND_TO_MAVROS_H
#define PX4CTRL_COMMAND_TO_MAVROS_H
...
public:
    ...
    void send_attitude_setpoint_yawrate(const easondrone_msgs::AttitudeReference &_AttitudeReference, float yaw_rate_sp);
...
//发送角度期望值至飞控（输入：期望角度-四元数,期望推力）
void command_to_mavros::send_attitude_setpoint_yawrate(const easondrone_msgs::AttitudeReference &_AttitudeReference, float yaw_rate_sp)
{
    mavros_msgs::AttitudeTarget att_setpoint;
...
#endif //PX4CTRL_COMMAND_TO_MAVROS_H
