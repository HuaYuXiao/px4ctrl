...
#ifndef PX4CTRL_STATE_FROM_MAVROS_H
#define PX4CTRL_STATE_FROM_MAVROS_H

/***************************************************************************************************************************
* 主要功能：
*    本库函数主要用于连接easondrone_control与mavros两个功能包。
...
public:
            ...
            state_nh("~")
    {
        ...
        // 【订阅】无人机当前状态 - 来自飞控
        extended_state_sub = state_nh.subscribe<mavros_msgs::ExtendedState>("/mavros/extended_state", 10, &state_from_mavros::extended_state_cb,this);
        ...
        alt_sub = state_nh.subscribe<std_msgs::Float64>("/mavros/global_position/rel_alt", 10, &state_from_mavros::alt_cb,this);
